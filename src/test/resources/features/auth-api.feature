...
Feature: Auth API Test
  ...
  Scenario: Register dengan email yang sudah terdaftar
    ...
    And Response body memiliki field "success" dengan nilai false
    And Response body memiliki field "error" dengan nilai "Email sudah terdaftar"
  ...
  Scenario: Login dengan kredensial yang valid
    ...
    And Response body memiliki field "data.token" tidak null
  ...
  Scenario: Mendapatkan data user yang sedang login
    ...
    Then Status code adalah 200
    And Response body memiliki field "success" dengan nilai true
    And Response body memiliki field "data.email" dengan nilai "hrzpitulas17@gmail.com"
  ...
  Scenario: Logout dari akun
    ...
    Then Status code adalah 200
    And Response body memiliki field "success" dengan nilai true
    And Response body memiliki field "message" dengan nilai "Logout berhasil"
